...
moment if it is still relatively young. This (like reclaiming) is
...
doesn't change between cycles its focus will increase (see
*Permanence*) otherwise concentration is broken and will begin again
